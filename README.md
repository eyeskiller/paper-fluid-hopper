...
1. Download the latest `fluid-hopper-1.0.3.jar` file from the releases (or build it from source).
...
3. Run the Gradle build wrapper:
   ...
   ./gradlew build
   ```
4. The compiled plugin will be located in `build/libs/fluid-hopper-1.0.3.jar`.
